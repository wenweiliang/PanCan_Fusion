Cancer_Type=$1
Driver_list="/diskmnt/Projects/Users/wliang/Pancan_Fusion/20_Driver3/DriverGeneList/driver.txt"
...
#Add the annotation of driver mutation from Amila
...
#Print out Hugo_Symbol, Variant_Type, Tumor_Barcode, DriverAnnotation in PsudoMAF


while read lines; do
Driver=$(echo $lines| awk -F " " '{print $1}')
#Generate two files here: One is mutation on driver gene, and the other one is driver mutations
