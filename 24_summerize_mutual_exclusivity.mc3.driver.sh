Cancer_Type=$1
Working_Directory="/diskmnt/Projects/Users/wliang/Pancan_Fusion/20_Driver3/Exclusive"
DriverList="/diskmnt/Projects/Users/wliang/Pancan_Fusion/20_Driver3/DriverGeneList/driver.txt"
SampleList="/diskmnt/Projects/Users/wliang/Pancan_Fusion/20_Driver3/IntersectSampleList/${Cancer_Type}.sample.txt"

echo -e "Sample\tCancer_Type\tMutationInDriverGene\tFusionInDriverGene\tDriverMutation" > ${Working_Directory}/${Cancer_Type}.exclusive.txt
while read lines; do 
